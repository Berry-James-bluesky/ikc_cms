...
class Quote extends Command
{
    ...
    {
        $this->setName('bluesky:email:quote')
            ->setDescription('Send Quote emails');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            $this->getState()->getLoggers()->getMasterLogger("bluesky")->error("bluesky-email-quote", $e->getMessage());
        } finally {
            $this->release();
        }
    }
